...
export const SpinnerIcon = ({ className = "w-5 h-5", color = "#2c78bb" }) => (
  <div className={`rounded-full border-2 border-t-transparent animate-spin ${className}`}
...
export const DotIcon = ({ className = "w-2.5 h-2.5" }) => (
...
export const ArrowUpIcon = ({ className = "w-3 h-3" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
